...
3. Hero over `/images/vendors-bg2.jpg` with dark overlay (vendors-bg.jpg is a duplicate of the organisers photo already used on the landing page). Eyebrow "FOR VENDORS", heading "Join the fastest-growing traditional ceremony platform", the specified body copy, and a single "Create your free profile" button.
...
5. "Win better. Work with less back-and-forth." — the four vendor benefit cards, with copy and icons duplicated as standalone markup inside the new file (no import from or reference to the current landing page, which is due for removal), followed by "I'm a vendor — Register" and the "Free to list your business. Approved within 48 hours." line.
