...
Deno.serve(async (req) => {
  ...
  // verify_jwt = true: the platform verifies the signature before this runs.
  // isInternalCall then narrows to service-role callers (cron via vault, confirm-delivery via env key).
