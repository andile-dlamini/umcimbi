      ...
      <section className="relative py-28 bg-background">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            { icon: BarChart3, title: 'Comparable quotes', body: 'Structured offers you can review side-by-side i.e. scope, price, terms.', gradient: 'from-secondary/[0.08] to-secondary/[0.02]', iconBg: 'bg-secondary/25', iconColor: 'text-secondary' },
            { icon: Inbox, title: 'One organised plan', body: 'Tasks, messages, and confirmations in one flow.', gradient: 'from-accent/[0.08] to-accent/[0.02]', iconBg: 'bg-accent/25', iconColor: 'text-accent' }].
