...
export const VENDOR_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'These four numbers track your last 30 days i.e. profile views, quotations sent, completed orders, and total payout. When all four are growing, your listing is working.',
  },
  {
  ...
  },
  {
    ...
    body: 'UMCIMBI holds all payments safely. A deposit is collected when a booking is confirmed, and the full balance 5 days before the ceremony. The deposit is paid immediately, as confirmation of the order. However, for the balance, please upload proof of delivery and your payout is sent straight to your bank account, no chasing clients for payment.',
  },
  {
    target: 'center',
    placement: 'center',
